...
#          Generate the Model Accuracy Comparison Table
# ==============================================================================
...
# This function calculates all 7 metrics required by the project specifications.
...
# Extracting time series parameters
n_total <- length(spi_ts)
actuals <- as.numeric(spi_ts)

# Arrays to store fitted values and next-period predictions for all 10 models
...
# ==============================================================================
# 7.4 Exponential Smoothing (Simple Exponential Smoothing)
# ==============================================================================
...
# ==============================================================================
# 7.5 Trend-Adjusted Exponential Smoothing (Holt's Linear Trend)
# ==============================================================================
...
# ==============================================================================
# AUTOMATIC ACCURACY COMPARISON TABLE GENERATION & EXPORT
# ==============================================================================
method_names <- c(
...
# Creating folder paths dynamically to match repo requirements
...
# Exporting directly to outputs/tables/accuracy_comparison.csv
